...
#from tkinter import Label, Frame, StringVar, Entry,Button, Listbox, LEFT, BOTH
...
button=Button(frame,text="ADD",font="arial 20 bold",width=6,bg="#ED7D31",fg="#fff",bd=0,command=addTask)
